# original code at https://github.com/BlackHC/batchbald_redux #pip install batchbald_redux
# paper : BatchBALD: Efficient and Diverse Batch Acquisition for Deep Bayesian Active Learning, Andreas Kirsch and Joost van Amersfoort and Yarin Gal, 2019
# We recovered from batchbald_redux package (Apache-2.0 Licence) the acquisition functions, computing entropy and joint entropy and selecting batches.
# These functions are cleaned the original code from most of the tqdm calls.
